...
/**
 * Created by parkjaeha on 2017-07-29.
 */

public class Info {
    //이미지 정보
    Integer[] imageIDs = {
            R.drawable.map1, R.drawable.map2, R.drawable.map3, R.drawable.map4, R.drawable.map5, R.drawable.map6, R.drawable.map7, R.drawable.map8,
            R.drawable.map9, R.drawable.random_map
    };
    //캐릭터 선택 이미지 정보
    Integer[] img_Cselect= {
            R.drawable.choice1,R.drawable.choice2,R.drawable.choice3,R.drawable.choice4
    };
